...
class FixedIssueTableScreen extends StatelessWidget {
  static const String routName = '/fixedIssue';
                ...
                children: [
                  ...
                  Expanded(
                    child: FutureBuilder<void>(
                        future: controller.fetchFixedIssues(),
                        builder: (context, snapshot) {
                          print("Here is data${controller.fixedIssue}");
                          ...
                          } else if (controller.fixedIssue.isEmpty) {
                            return Center(
                                child:
                                    const Text("You have no fixed issue yet"));
                          } else {
                            return Center(
                              child: ListView.builder(
                                itemBuilder: (context, index) {
                                  final issue = controller.fixedIssue[index];
                                ...
                                itemCount: controller.fixedIssue.length,
                              ),
                            );
                          }
                        }),
