...
class FixedIssueDetailScreen extends StatelessWidget {
  IssueModel issueModel;

  static const String routName = "/issueDetail";
  FixedIssueDetailScreen({super.key, required this.issueModel});
  @override
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: CustomButton(
                    onpressed: () {
                      Navigator.pushNamed(
                          context, StillNotFixedIssueScreen.routName,
