...
class MaintainerIssueDetailScreen extends StatelessWidget {
  IssueModel issueModel;
  Color color;
  static const String routName = "/maintainerIssueDetail";
  MaintainerIssueDetailScreen(
      {super.key, required this.issueModel, required this.color});
  @override
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: CustomButton(
                    onpressed: () {
                      Navigator.pushNamed(context, AssignIssueScreen.routName,
